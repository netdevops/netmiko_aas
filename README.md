...
```
curl -X POST "http://localhost:8000/api/auth/" -H "accept: application/json" -H "Content-Type: application/json" -d "{ \"username\": \"jtdub\", \"password\": \"somepassword\"}"
...
### GET (single post)
```
curl -X GET http://localhost:8000/api/v1/netmiko/1/ -H "Authorization: Token 70fe753a3e602f0da51ef05a9f3c59d7c52e9649"
...
```
curl -X GET http://localhost:8000/api/v1/netmiko/ -H "Authorization: Token 70fe753a3e602f0da51ef05a9f3c59d7c52e9649"
